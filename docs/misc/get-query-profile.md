...
Query Profile 一般包含以下字段，详情可参见 [查看分析 Query Profile](../../../best_practices/query_tuning/query-profile-overview.md)。
...
+-----------------------------------------------------------------------------------------------------------------------+
| QueryPeakMemoryUsage:  KB                                                                                        |
+-----------------------------------------------------------------------------------------------------------------------+
```

## 相关函数

- [last_query_id](./last-query-id.md)
- [regexp_extract](../like-predicate-functions/regexp-extract.md)
