...
ClusterDecommissioned: false
     ...
     DataUsedCapacity:  
       ...
       MaxDiskUsedPct:  %
               ErrMsg: 
              Version: BRANCH--RELEASE-8eb8705
...
+-------+--------------------+----------+----------------+--------------------------+---------------------+
| 1     | information_schema | 54       |  TB | NULL                     | 9223372036854775807 |
| 100   | sys                | 6        |  TB | NULL                     | 9223372036854775807 |
| 10001 | _statistics_       | 12       |  TB | NULL                     | 9223372036854775807 |
| 10015 | test               | 1        |  TB | NULL                     | 9223372036854775807 |
+-------+--------------------+----------+----------------+--------------------------+---------------------+
4 rows in set ( sec)
...
| 12711 | default_cluster:akashx_audit_db__ |
+-------+--------------------------------------+
3 rows in set ( sec)
...
+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+------------+----------------+-------------+----------+
|     | 24010_lineitem_str_g1      | 177672                                                                                                                                            | 12         | 1              | varchar(-1) | true     |
|     | 24010_lineitem_str_g2      | 182144                                                                                                                                            | 192        | 1              | varchar(-1) | true     |
|  | 1439318_group_agent_uid    | 1735677, 1738390                                                                                                                                  | 12         | 2              | bigint(20)  | true     |
|      | 24010_gsdaf2449s9e         | 37802                                                                                                                                             | 192        | 1              | int(11)     | true     |
|    | 174844_groupa4             | 175368, 591307, 591362, 591389, 591416                                                                                                            | 12         | 1              | int(11)     | true     |
|      | 24010_group2               | 30585, 30669                                                                                                                                      | 12         | 1              | int(11)     | true     |
|     | 10005_lineorder_str_normal | 181364                                                                                                                                            | 192        | 1              | varchar(-1) | true     |
|  | 1904968_groupa2            | 5973173                                                                                                                                           | 12         | 1              | int(11)     | true     |
|     | 24010_lineitem_str_g3      | 182533                                                                                                                                            | 192        | 1              | varchar(-1) | true     |
+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+------------+----------------+-------------+----------+
```
...
+---------------------+---------------+--------------------------------------+--------------+----------+------+------------+--------------+-------------+---------------+----------+----------+-------------------+---------------+---------------+
| 2025-03-07 02:00:19 | .227 | ddbd69b9-fab4-11ef-8063-461f20abc3f0 | 11           | tpcds_2  | root |  MB | 5859503 rows |  MB  |  B       |  s |  s  | default_warehouse |               | rg1           |
+---------------------+---------------+--------------------------------------+--------------+----------+------+------------+--------------+-------------+---------------+----------+----------+-------------------+---------------+---------------+
```
...
| StartTime           | feIp          | QueryId                              | ConnectionId | Database | User | ScanBytes  | ScanRows     | MemoryUsage | DiskSpillSize | CPUTime | ExecTime | Warehouse         | CustomQueryId | ResourceGroup |
+---------------------+---------------+--------------------------------------+--------------+----------+------+------------+--------------+-------------+---------------+---------+----------+-------------------+---------------+---------------+
| 2025-03-07 02:02:47 | .227 | 3603d566-fab5-11ef-8063-461f20abc3f0 | 12           | tpcds_2  | root |  MB | 4899036 rows |  MB  |  B       |  s |  s  | default_warehouse |               | rg1           |
+---------------------+---------------+--------------------------------------+--------------+----------+------+------------+--------------+-------------+---------------+---------+----------+-------------------+---------------+---------------+
