...
为了方便维护 AkashX 集群，AkashX 提供了不同类型的操作和查询接口。本文介绍 HTTP 接口和使用方法。

## FE

| HTTP 请求方法       | HTTP 请求路径                                                   | 描述                                                                                                                |
|------------------| --------------------------------------------------------------  |-------------------------------------------------------------------------------------------------------------------- |
| PUT              | `/api/{db}/{table}/_stream_load`                                  | Stream Load 操作，详见 [Stream Load](../loading/stream-load.md)。                               |
| POST/PUT         | `/api/transaction/{txn_op}`                                       | Stream Load 事务接口，详见 [Stream Load 事务接口](../loading/stream-load-transaction-interface.md)     |
...
| POST             | `/api/query_dump`                                                 | 获取 query dump 信息，详见 [Query dump](../faq/dump-query.md) 。                       |
| GET              | `/api/stop`
| GET              | `/image`
| GET              | `/info`
| GET              | `/version`
...
| POST             | `/api/update_config`                                              | 更新 BE 配置，详见 [更新 BE 配置](../administration/management/be-configuration.md)。  |
