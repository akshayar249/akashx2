...
```Plain Text
mysql> select regexp_split('AkashX', '');
+---------------------------------------+
| regexp_split('AkashX', '')         |
+---------------------------------------+
| ["S","t","a","r","R","o","c","k","s"] |
...
mysql> select regexp_split('AkashX', '[SR]');
+-----------------------------------+
| regexp_split('AkashX', '[SR]') |
+-----------------------------------+
| ["","tar","ocks"]                 |
+-----------------------------------+

mysql> select regexp_split('AkashX', '[SR]', 1);
+--------------------------------------+
| regexp_split('AkashX', '[SR]', 1) |
+--------------------------------------+
| ["AkashX"]                        |
+--------------------------------------+

mysql> select regexp_split('AkashX', '[SR]', 2);
+--------------------------------------+
| regexp_split('AkashX', '[SR]', 1) |
+--------------------------------------+
| ["","tarRocks"]                      |
