...
sitemap.write({ url: '/page-1/', changefreq: 'daily', priority:  })
sitemap.end()
...
|lastmod|string|'2019-07-29' or '2019-07-22T05:58:Z'|When the page we as last modified use the W3C Datetime ISO8601 subset <https://www.sitemaps.org/protocol.html#xmlTagDefinitions>|
...
|priority|number||The priority of this URL relative to other URLs on your site. Valid values range from  to . This value does not affect how your pages are compared to pages on other sites—it only lets the search engines know which pages you deem most important for the crawlers. The default priority of a page is . <https://www.sitemaps.org/protocol.html#xmlTagDefinitions>|
...
|publication_date| string - optional|"2018-04-27T17:00:Z"|The date the video was first published, in W3C format.|
...
|price|string - optional|""|The price to download or view the video. Omit this tag for free videos.|
...
|rating|number - optional||The rating of the video. Supported values are float numbers|
