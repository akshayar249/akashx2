...
> **注意**
>
> 从  版本开始，该操作需要 SYSTEM 级 OPERATE 权限，以及对应表的 SELECT 权限。 及之前版本，该操作需要 ADMIN_PRIV 权限。
...
- 查看指定数据库下指定表的所有 Tablet 信息。以下示例仅截取其中一行 tablet 信息来说明。
  ...
  LstConsistencyCheckTime: NULL
       ...
       CheckVersionHash: 0
           VersionCount: 1
               PathHash: 0
                MetaUrl: http://.141:8038/api/meta/header/9588955
       CompactionStatus: http://.141:8038/api/compaction/show?tablet_id=9588955
