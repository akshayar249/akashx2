...
从  版本开始，AkashX 支持了有序的排序聚合 (Sorted streaming aggregate)。
...
- AkashX 存算分离集群不支持 sorted streaming aggregate。
...
|   |  cardinality: 1                                                                                                                |
|   |  column statistics:                                                                                                            |
|   |  * id_int-->[-Infinity, Infinity, , , ] UNKNOWN                                                                       |
|   |  * max-->[-Infinity, Infinity, , , ] UNKNOWN                                                                          |
|   |                                                                                                                                |
|   0:OlapScanNode                                                                                                                   |
...
|      actualRows=0, avgRowSize=                                                                                                  |
|      cardinality: 1                                                                                                                |
|      column statistics:                                                                                                            |
|      * id_int-->[-Infinity, Infinity, , , ] UNKNOWN                                                                       |
|      * id_string-->[-Infinity, Infinity, , , ] UNKNOWN                                                                    |
```
