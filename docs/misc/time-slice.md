...
- `INTERVAL N type`：时间粒度周期，例如 `interval 5 second` 表示时间粒度为 5 秒。
  ...
  - `type` 是时间粒度周期的单位，取值可以是 YEAR，QUARTER，MONTH，WEEK，DAY，HOUR，MINUTE，SECOND，MILLISECOND（ 及以后），MICROSECOND（ 及以后）。

- `boundary`：可选，用于指定返回时间周期的起始时刻 (`FLOOR`) 还是结束时刻 (`CEIL`)。取值范围：FLOOR，CEIL。如果不指定，默认为 `FLOOR`。该参数从  版本开始支持。
...
+---------------------+-------------------------------------------------------+
| 1691-12-23 04:01:09 | 1691-12-23 04:01:                            |
| 2169-12-18 15:44:31 | 2169-12-18 15:44:                            |
| 1840-11-23 13:09:50 | 1840-11-23 13:09:                            |
| 1751-03-21 00:19:04 | 1751-03-21 00:19:                            |
| 1861-09-12 13:28:18 | 1861-09-12 13:28:                            |
+---------------------+-------------------------------------------------------+
```
