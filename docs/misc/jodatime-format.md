...
示例八：将日期 `2023-06-25 00:00:00` 转换为 `yyyyMMdd ''akashx''` 格式的字符串。

```SQL
MySQL > select jodatime_format('2023-06-25 00:00:00', 'yyyyMMdd ''akashx''');
+------------------------------------------------------------------+
| jodatime_format('2023-06-25 00:00:00', 'yyyyMMdd \'akashx\'') |
+------------------------------------------------------------------+
| 20230625 akashx                                               |
+------------------------------------------------------------------+
```
