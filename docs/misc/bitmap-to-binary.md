...
将 Bitmap 根据 AkashX 定义的规则，转换为二进制字符串。

该函数主要用于将 Bitmap 数据导出，压缩效果要好于 [bitmap_to_base64](./bitmap-to-base64.md)，如果要导出 Bitmap 数据到 Parquet 等二进制文件，建议用 bitmap_to_binary 函数。
