...
关于基础统计信息，请参见[CBO 统计信息](../../../using_akashx/cost-based-optimizer.md#统计信息数据类型)。
...
关于直方图的说明，请参见[CBO 统计信息](../../../using_akashx/cost-based-optimizer.md#统计信息数据类型)。
...
[SHOW ANALYZE STATUS](show-analyze-status.md)：查看当前所有**手动采集任务**的状态。

[KILL ANALYZE](kill-analyze.md)：取消**正在运行中（Running）**的统计信息收集任务。
