...
- 对于  之前的版本，AkashX 支持基于 [Fast DECIMAL](#fast-decimal) 的 DECIMAL128。
- 对于  及更高版本，AkashX 支持 [DECIMAL256](#decimal256)。
...
从  开始，AkashX 支持在 [ARRAY](../semi_structured/array.md)、[MAP](../semi_structured/map.md) 和 [STRUCT](../semi_structured/struct.md) 中使用 Fast Decimal 类型。

## DECIMAL256

AkashX 从  开始引入 DECIMAL256。
...
```SQL
INSERT INTO test_decimal256(p50s48) SELECT ;
```
