...
| processlist_id          | 需要终止的线程的 ID。 您可以通过 [SHOW PROCESSLIST](show-processlist.md) 获取正在执行的线程的 ID。 |
...
+------+------+---------------------+--------+---------+---------------------+------+-------+-----------------------+-----------+
|   20 | root | xxx.xx.xxx.xx:xxxxx | ax_hub | Query   | 2023-01-05 16:30:19 |    0 | OK    | show full processlist | false     |
+------+------+---------------------+--------+---------+---------------------+------+-------+-----------------------+-----------+
1 row in set ( sec)
