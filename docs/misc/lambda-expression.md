...
从  版本开始，AkashX 支持在以下高阶函数 (higher-order function) 中应用 Lambda 表达式：[array_map()](./array-functions/array-map.md)，[array_filter()](./array-functions/array-filter.md)，[array_sum()](./array-functions/array-sum.md)，[array_sortby()](./array-functions/array-sortby.md)。
