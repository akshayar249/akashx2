...
非常感谢您参与 AkashX 文档建设，您的帮助和意见是文档改进的关键！
...
1. 进入文档编辑页面。
   ...
   - 方式二：登录 GitHub，直接在[中文文档仓库](https://github.com/AkashX/akashx/tree/main/docs/zh)找到对应文档，单击文档右上角的铅笔图标，进入文档编辑页面。
...
5. PR 进入评审阶段，评审通过后，文档变更会合入至 AkashX 文档仓库，并最终更新至官网。
   评审阶段分为自动检查和人工评审。
   1. 自动检查：提交人是否已经签署[CLA](https://cla-assistant.io/AkashX/akashx)，提交文档是否符合markdown语法。
   2. 人工评审：AkashX Committer 会阅读并沟通文档内容。最终合入至akashx文档仓库，并更新官网。

## 贡献新文档

### 注意事项

1. akashx文档仓库使用 markdown 格式，贡献文档前，请熟悉基本的 markdown 语法。
...
5. 引用：如果引用官网文档，推荐使用文档相对路径，比如 `[test md](./data_source/catalog/hive-catalog.md)(../zh/data_source/catalog/hive-catalog.md)`。如果引用外部文档，则引用格式为 `[引用文档名称](引用文档链接)`。
6. 代码块：代码块必须标明语言类型，比如：`sql`，`json`。

### 编写流程

1. 登录 GitHub 帐户，直接在[中文文档仓库](https://github.com/AkashX/akashx/tree/main/docs/zh)单击 Add file，进入新文档编辑页面。
...
4. PR 进入评审阶段，评审通过后，文档变更会合入至 AkashX 文档仓库，并最终更新至官网。

## 文档模板

- [函数文档模板](./sql-reference//how-to-write-functions-documentation.md)
- [SQL命令模板](./sql-reference/how-to-write-sql-command-doc.md)
- [参数/变量模板](./sql-reference/template-for-config.md)
