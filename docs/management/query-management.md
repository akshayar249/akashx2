...
> **说明**
>
> - 自  版本起，正式发布 Pipeline 引擎。
> - 自  版本起，支持根据查询并发度自适应调节 `pipeline_dop`。
...
详细内容，参考 [ALTER DATABASE](../../../sql-reference/sql-statements/Database/alter-database.md)
...
+------+--------------+---------------------+-----------------+-------------------+---------+------+-------+------+
|    1 | akashxmgr | .147:56208 | default_cluster | akashx_monitor | Sleep   |    8 |       |      |
|  129 | root         | .139:54818 | default_cluster |                   | Query   |    0 |       |      |
|  114 | test         | .147:57974 | default_cluster | ssb_100g          | Query   |    3 |       |      |
|    3 | akashxmgr | .147:57268 | default_cluster | akashx_monitor | Sleep   |    8 |       |      |
|  100 | root         | .147:58472 | default_cluster | ssb_100           | Sleep   |  637 |       |      |
|  117 | akashxmgr | .147:33790 | default_cluster | akashx_monitor | Sleep   |    8 |       |      |
|    6 | akashxmgr | .147:57632 | default_cluster | akashx_monitor | Sleep   |    8 |       |      |
|  119 | akashxmgr | .147:33804 | default_cluster | akashx_monitor | Sleep   |    8 |       |      |
|  111 | root         | .139:55472 | default_cluster |                   | Sleep   | 2758 |       |      |
+------+--------------+---------------------+-----------------+-------------------+---------+------+-------+------+
9 rows in set ( sec)
