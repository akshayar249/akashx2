<p align="center">
  ...
  <p align="center">
    <a href="https://npmjs.com/package/@algolia/client-personalization"><img src="https://img.shields.io/npm/v/@algolia/client-personalization.svg?style=flat-square" alt="NPM version"></img></a>
...
```bash
yarn add @algolia/client-personalization@5.50.2
# or
npm install @algolia/client-personalization@5.50.2
# or
pnpm add @algolia/client-personalization@5.50.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-personalization@5.50.2/dist/builds/browser.umd.js"></script>
```
