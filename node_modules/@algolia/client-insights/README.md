...
```bash
yarn add @algolia/client-insights@5.50.2
# or
npm install @algolia/client-insights@5.50.2
# or
pnpm add @algolia/client-insights@5.50.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-insights@5.50.2/dist/builds/browser.umd.js"></script>
```
