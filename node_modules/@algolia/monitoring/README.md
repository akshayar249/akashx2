<p align="center">
  ...
  <p align="center">
    <a href="https://npmjs.com/package/@algolia/monitoring"><img src="https://img.shields.io/npm/v/@algolia/monitoring.svg?style=flat-square" alt="NPM version"></img></a>
...
```bash
yarn add @algolia/monitoring@1.50.2
# or
npm install @algolia/monitoring@1.50.2
# or
pnpm add @algolia/monitoring@1.50.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/monitoring@1.50.2/dist/builds/browser.umd.js"></script>
```
